...
import heroImage from "../../assets/arpan.jpeg";
  ...
  return (
    <div className="bg-black text-white text-center py-16">
      <img
        src={heroImage}
        alt=""
        className="mx-auto mb-8 w-48 h-48  rounded-full object-cover transform transition-transform duration-400 hover:scale-120 "
      ></img>
